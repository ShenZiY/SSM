...
public class testController {
    ...
    public void generatePdf() throws IOException, DocumentException {
        BaseInfo baseInfo = baseInfoService.findBaseInfoByAccId(20195061);
        EnvInfo envInfo = envInfoService.findEnvInfoByAccId(20195061);
        // 模板路径
        String templatePath = "D:/PDF/表A111.pdf";
        // 生成的新文件路径
        String newPDFPath = "D:/PDF/表A12172.pdf";
        PdfReader reader;
        ...
        try {
            ...
            if(handleMultiple(baseInfo.getFireTru()).equals("1")){
                form.setField("timeFiretru",handleDate(baseInfo.getTimeFiretru().toString()));
            }
            if(handleMultiple(baseInfo.getAmbulance()).equals("1")){
