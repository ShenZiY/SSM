...
public class B4OuterInfo {
    ...
    @ExcelField(value = "外接充电线路")
    private String wjcdxl;
    ...
    public void setJcg(String jcg) {
        this.jcg = jcg == null ? null : jcg.trim();
    }
    ...
    public String getWjcdxl() {
        return wjcdxl;
    }

    public void setWjcdxl(String wjcdxl) {
        this.wjcdxl = wjcdxl == null ? null : wjcdxl.trim();
    }
}